...
export default function QRScanPage() {
    ...
    // Public Profile State (SANITIZED - NO MEDICAL DATA)
    ...
    const [resolvedPatientId, setResolvedPatientId] = useState(profileId || username || '');
        ...
        const fetchProfile = async () => {
             ...
             try {
                ...
                if (snap.exists()) {
                    ...
                    // SANITIZED PUBLIC EMERGENCY DATA ONLY (Section 3)
                    setPublicUser({
    ...
    // Alternate Verification Clinical Override
            ...
            <div className="max-w-xl mx-auto space-y-8 pb-40 px-5 pt-12">
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    {!isMedicalAuthorized ? (
                        ...
                        /* ============================================================
                           AUTHORIZED MEDICAL DOSSIER (UNLOCKED AFTER VERIFICATION)
                           ============================================================ */
                        <div className="bg-[#11192A] rounded-[40px] border-2 border-emerald-500/30 p-8 sm:p-10 space-y-8 shadow-2xl relative overflow-hidden animate-in fade-in duration-500">
                            ...
                            <EmergencyInfoSections 
                                data={authorizedMedicalData || {}} 
                                insurance={authorizedMedicalData?.insurance || {}}
                                isAuthorized={true}
                            />
                        </div>
                    )}
